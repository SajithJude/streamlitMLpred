...
# url = st.selectbox('Select The Colab Implementation You want to see', lst)
...
st.markdown("[Visualizing https://colab.research.google.com/drive/15j6SFRLdbFVyZRMKpas4oXZi1X9vr4sY?usp=sharing")
st.markdown("[Machine learning https://colab.research.google.com/drive/1kI2u2PCaLam2nJaxq-VwfZTujlOALYul?usp=sharing")
